...
export const Carousels = (props) => {
    ...
    return (
      <div className="carousels">
        <div className="venue">
          <Carousel className="venue-carousel" fade prevLabel={null} nextLabel={null}
          ...
          <text className="carousel-label">{props.venueLabel}</text>
        </div>
        <div className="winners">
          <Carousel className="winners-carousel" fade prevLabel={null} nextLabel={null}
                    keyboard={false} interval={2800}>
            {props.winners ?
          ...
          <text className="carousel-label">{props.winnerLabel}</text>
        </div>
      </div>
    )
}
